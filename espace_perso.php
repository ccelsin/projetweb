...
?>
  ...
  <div class="card-body">
    ...
    <a href="tt_favoris.php?id=' . $row['id'] . '" class="btn btn-danger" role="button" style="margin-left: 7.8vw;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
